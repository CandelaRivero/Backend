...
import usersService from '../models/Users.js.js.js.js';
import {isValidPassword} from '../utils.js.js.js.js'
...
router.post('/loginjwt',async(req,res)=>{
    ...
    let token = jwt.sign({name:user.name,email:user.email,id:user._id},"Coder",{expiresIn:"24h"})
